...
<div id="tabs">
	...
	<div id="tabs-1">
		<p id="connected"><b><a href="javascript:WebSocketTest()" class="btn btn-warning"><span class="glyphicon glyphicon-link"></span> Connect to Arduino/pymata</a></b></p>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Latch Event Occurred On:</b>
		<input id="dlevent18" name="pin" class="element text medium" type="text" maxlength="255" value="" style="width: 500px;"/>
		<br>
		...
		<b>Pin 19:</b>
		<input id="ip19" name="pin" class="element text medium" type="text" maxlength="255" value="0" style="width: 20px;"/>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Data Latch</b>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Latch Event Occurred On:</b>
		<input id="dlevent19" name="pin" class="element text medium" type="text" maxlength="255" value="" style="width: 500px;"/>
		<br>
		
		<input type="radio" name="e20" value="0" id="in19d" onclick="clicked(this.id);" checked>Disabled
		<input type="radio" name="e20" value="1" id="out19d" onclick="clicked(this.id);">Enabled
		<b>Pin 20:</b>
		<input id="ip20" name="pin" class="element text medium" type="text" maxlength="255" value="0" style="width: 20px;"/>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Data Latch</b>
		<select id="dlatch19" onchange="digitalLatch('20', (this.id));">
			<option value="1">No Latch Set</option>
			<option value="2">Latch High</option>
			<option value="3">Latch Low</option>
		</select>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Latch Event Occurred On:</b>
		<input id="dlevent20" name="pin" class="element text medium" type="text" maxlength="255" value="" style="width: 500px;"/>
		<br>
		
		<input type="radio" name="e21" value="0" id="in19d" onclick="clicked(this.id);" checked>Disabled
		<input type="radio" name="e21" value="1" id="out19d" onclick="clicked(this.id);">Enabled
		<b>Pin 21:</b>
		<input id="ip21" name="pin" class="element text medium" type="text" maxlength="255" value="0" style="width: 20px;"/>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Data Latch</b>
		<select id="dlatch21" onchange="digitalLatch('21' (this.id));">
			<option value="1">No Latch Set</option>
			<option value="2">Latch High</option>
			<option value="3">Latch Low</option>
		</select>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b>Latch Event Occurred On:</b>
		<input id="dlevent21" name="pin" class="element text medium" type="text" maxlength="255" value="" style="width: 500px;"/>
		<br>
