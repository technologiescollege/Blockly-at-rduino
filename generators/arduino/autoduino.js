...
Blockly.Arduino.autoduino_rotary_angle = function() { // TO BE UPDATED
    ...
    Blockly.Arduino.setups_['setup_autoduino_encoder'] = getInput('30')+';\n';
    Blockly.Arduino.setups_['setup_autoduino_encoder'] += getInput('31')+';\n';
...
Blockly.Arduino.autoduino_piezo_buzzer = function() {
    ...
    Blockly.Arduino.definitions_['define_autoduino_piezo_buzzer'] = myLibrary_tone; 
