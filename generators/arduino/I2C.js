...
Blockly.Arduino.I2C_init = function() {
	...
	Blockly.Arduino.definitions_['define_pin_SCL']  = '#define SCL_PIN '+Pin_SCL;
	Blockly.Arduino.definitions_['define_port_SCL'] = '#define SCL_PORT PORT'+Port_SCL;
	Blockly.Arduino.definitions_['define_pin_SDA']  = '#define SDA_PIN '+Pin_SDA;
	Blockly.Arduino.definitions_['define_port_SDA'] = '#define SDA_PORT PORT'+Port_SDA;
	Blockly.Arduino.definitions_['define_I2C_soft'] = '#include <SoftI2CMaster.h>';
