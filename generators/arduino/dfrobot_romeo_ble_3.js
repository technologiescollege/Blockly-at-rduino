...
Blockly.Arduino.romeo_ble_M2_PWM = function() {
	var pindir1 = 7;
	var pinpwm1 = 6;
	//var value_sens1 = false;
	//var value_vitesse1 = 255;
...
Blockly.Arduino.romeo_ble_M1_sens = function() {
	var pindir2 = 4;
	var pinpwm2 = 5;
...
Blockly.Arduino.romeo_ble_M1_PWM = function() {
	var pindir2 = 4;
	var pinpwm2 = 5;
	//var value_sens2 = false;
	//var value_vitesse2 = 255;
...
Blockly.Arduino.romeo_ble_switch = function() {
	var select_switch = this.getFieldValue('SWITCH');
	var code="analogRead(7) == " + select_switch;
