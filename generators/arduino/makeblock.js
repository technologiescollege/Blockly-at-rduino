...
myLibrary_tone = "void NewTone(uint8_t pin, unsigned long frequency, unsigned long length = 0);\n\
...
//  var dropdown_pin2 = Port[1]; // Port_number[1]
  ...
  Blockly.Arduino.definitions_['define_makeblock_ultrasonic'] = myLibrary_ultrasonic;
...
//    var dropdown_pin = this.getFieldValue('PIN');
    ...
    Blockly.Arduino.definitions_['define_makeblock_piezo_buzzer'] = myLibrary_tone; 
...
myEdgeFunction = "boolean makeblock_edge(boolean* memory, boolean input) {\n\
    if (input & ~(*memory)) {\n\
        *memory = input;\n\
        return true;\n\
    }\n\
...
Blockly.Arduino.makeblock_edge_detection = function() {
    ...
    Blockly.Arduino.definitions_['var_makeblock_edge'] = myEdgeFunction;
