...
Blockly.Blocks['spi_setup'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField(Blockly.Msg.SPI_SETUP_SHIFT)
        .appendField(
    ...
    this.appendDummyInput()
        ...
        .appendField(
            ...
            'SPI_MODE');
    this.setTooltip(Blockly.Msg.SPI_SETUP_TIP);
  },
  /**
...
Blockly.Blocks['spi_transfer'] = {
  ...
  init: function() {
    ...
    var slaveNone = [[Blockly.Msg.SPI_TRANS_NONE, 'none']];
    ...
    this.appendDummyInput()
        .appendField(Blockly.Msg.SPI_TRANS_SLAVE)
        .appendField(
  ...
  onchange: function() {
    ...
    if (!setupInstancePresent) {
      this.setWarningText(Blockly.Msg.SPI_TRANS_WARN1.replace('%1', thisInstanceName),
								  'spi_setup');
    } else {
  ...
  updateFields: function() {
    ...
    if (!currentValuePresent) {
      this.setWarningText(Blockly.Msg.SPI_TRANS_WARN2.replace('%1', fieldValue),
			  'bPin');
    } else {
...
Blockly.Blocks['spi_transfer_return'] = {
  ...
  init: function() {
    ...
    this.setInputsInline(true);
    this.setOutput(true);
    this.setTooltip(Blockly.Msg.SPI_TRANSRETURN_TIP);
  },
