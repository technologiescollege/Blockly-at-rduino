...
Blockly.Blocks.grove_oled_draw_4strings.getBlockType = function() {
	return Blockly.Types.BOOLEAN;
};
Blockly.Blocks.grove_oled_print.getBlockType = function() {
	return Blockly.Types.BOOLEAN;
};
Blockly.Blocks.grove_oled_4draw_print.getBlockType = function() {
	return Blockly.Types.BOOLEAN;
};
...
Blockly.Blocks.grove_pressure_read.getBlockType = function() {
	return Blockly.Types.DECIMAL;
};
Blockly.Blocks.grove_gyro_read.getBlockType = function() {
	return Blockly.Types.DECIMAL;
};