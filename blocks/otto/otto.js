...
//otto block
//http://www.seeedstudio.com/depot/emax-9g-es08a-high-sensitive-mini-otto-p-760.html?cPath=170_171

Blockly.Blocks.otto_attach = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blocks/otto/otto_servo.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
    this.appendDummyInput("")
...
Blockly.Blocks.otto_read_degrees = {
  init: function() {
    this.setColour(Blockly.Blocks.otto.HUE);
...
Blockly.Blocks.otto_attached = {
  init: function() {
	this.setColour(Blockly.Blocks.otto.HUE);
	this.setHelpUrl('http://www.arduino.cc/playground/ComponentLib/otto');
    this.appendDummyInput("")
    ...
    this.setTooltip('true if the otto is attached to pin; false otherwise. ');
  },
  /**
   * Called whenever anything on the workspace changes.
   * It checks/warns if the selected instance has a config block.
...
Blockly.Blocks.otto_detach = {
  init: function() {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Release a pin from otto driving.');
  },
  /**
   * Called whenever anything on the workspace changes.
   * It checks/warns if the selected instance has a config block.
...
Blockly.Blocks.otto_rot_continue = {
  init: function() {
    this.setColour(Blockly.Blocks.otto.HUE);
...
Blockly.Blocks.otto_rot_continue_param = {
  init: function() {
    this.setColour(Blockly.Blocks.otto.HUE);
    this.setHelpUrl(Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_HELPURL);
	this.appendDummyInput()
