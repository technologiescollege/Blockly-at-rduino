...
Blockly.Blocks['lp2i_mp3_init'] = {
  init: function() {
    this.appendDummyInput()
		...
		.appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blocks/dfrobot_dfplayer-mini-mp3/dfrobot_dfplayer-mini-mp3.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
