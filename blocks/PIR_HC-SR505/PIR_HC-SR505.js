...
goog.provide('Blockly.Blocks.PIR_HC-SR505');

goog.require('Blockly.Blocks');
goog.require('Blockly.Types');

Blockly.Blocks.PIR_HC-SR505_detect = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blocks/PIR_HC-SR505/PIR_HC-SR505.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));	
