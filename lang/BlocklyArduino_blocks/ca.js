...
Blockly.Msg.CAT_STENDHAL_ANALOG2 = "  * * Analògic";
Blockly.Msg.CAT_STENDHAL_DIGITAL3 = "  . . . Digital";
Blockly.Msg.CAT_STENDHAL_ANALOG3 = "  . . . Analògic";
Blockly.Msg.CAT_STENDHAL_DEAL = "  * * Interruptor a distància";
Blockly.Msg.CAT_STENDHAL_OUT = " - Accionament";
Blockly.Msg.CAT_STENDHAL_OUT_MOTOR = "  * * Moviment";
Blockly.Msg.CAT_STENDHAL_OUT_MOTOR_SERVO = "  . . . Servomotors";
Blockly.Msg.CAT_STENDHAL_OUT_MOTOR_CLASSIC = "  . . . Motors de corrent continua";
Blockly.Msg.CAT_STENDHAL_OUT_MOTOR_PAP = "  . . . Motors pas a pas";
Blockly.Msg.CAT_STENDHAL_OUT_LIGHT = "  * * Llum";
Blockly.Msg.CAT_STENDHAL_OUT_SOUND = "  * * So";
Blockly.Msg.CAT_STENDHAL_COMM = " - Comunicació";
...
Blockly.Msg.CAT_STENDHAL_TIME = "  * *  Rellotge";
Blockly.Msg.CAT_STENDHAL_MEMORY = "  * *  Memòria";
...
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT1 = "reprodueix el to al piezo";
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT2 = "nota";
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT3 = "escala";
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT4 = "temps";
Blockly.Msg.GROVE_BK_OLED_TEXT1 = "escriu al OLED al I2C";
Blockly.Msg.GROVE_BK_OLED_TEXT2 = "entrada (cadena o número)";
Blockly.Msg.GROVE_BK_OLED_TEXT3 = "línia (0~3)";
Blockly.Msg.GROVE_BK_OLED_TEXT4 = "columna (0~15)";
Blockly.Msg.GROVE_BK_OLED_TEXT5 = "refresca la línia";
...
Blockly.Msg.GROVE_BK_OLED_TOOLTIP = 'imprimeix a la pantalla OLED';
...
Blockly.Msg.STENDHAL_INOUT_DHT_READ_H = "de % d'humitat";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_PIN = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_SENSOR = "mesurat pel captador d'aire";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_TOOLTIP = "els captadors del tipus DHT tenen dos components : termistor i captador de humitat.";
...
Blockly.Msg.STENDHAL_INOUT_LED_INPUT2 = "qui està connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_LED_INPUT3 = "a l'estat";
Blockly.Msg.STENDHAL_INOUT_LED_TOOLTIP = "activa la sortida lògica sobre la qual està el LED connectat";
...
Blockly.Msg.STENDHAL_INOUT_BUTTON_TEXT = "l'estat del botó polsador";
Blockly.Msg.STENDHAL_INOUT_BUTTON_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_BUTTON_TOOLTIP = "captador digital, retorna activat(1) o desactivat(0)";
...
Blockly.Msg.STENDHAL_INOUT_TACTILE_TEXT = "l'estat del botó tàctil";
Blockly.Msg.STENDHAL_INOUT_TACTILE_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_TACTILE_TOOLTIP = "captador digital, retorna activat(1) o desactivat(0)";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_HELPURL = "http://microcontrollerslab.com/reed-switch-arduino-field-dectection/";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_TEXT = "l'estat del detector de l'imant";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_TOOLTIP = "captador digital, retorna activat(1) o desactivat(0)";
...
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_TEXT = "l'estat del captador de xoc";
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_TOOLTIP = "captador digital, retorna activat(1) o desactivat(0)";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_TEXT = "el valor analògic del captador de l'angle rotació";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_TOOLTIP = "captador analògic, el bloc retorna un valor comprés entre 0 i 1023";
Blockly.Msg.STENDHAL_INOUT_TILT_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_TILT_TEXT = "l'estat del sensor de moviment";
Blockly.Msg.STENDHAL_INOUT_TILT_INPUT = "al pin";
Blockly.Msg.STENDHAL_INOUT_TILT_TOOLTIP = "Quant el contactor no es toca, el circuit està obert, d'altra forma quan el contactor ha estat tocat el circuit està tancat.";
Blockly.Msg.STENDHAL_INOUT_BUZZER_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_BUZZER_TEXT1 = "el brunzidor";
Blockly.Msg.STENDHAL_INOUT_BUZZER_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_BUZZER_TOOLTIP = "emet un so quan el buzzer està activat";
Blockly.Msg.STENDHAL_INOUT_RELAY_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_RELAY_TEXT1 = "el relé";
Blockly.Msg.STENDHAL_INOUT_RELAY_INPUT = "que està connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_RELAY_TOOLTIP = "El relé és un interruptor remot, és un interruptor posat en un circuït de potència que està accionat per una senyal digital";
...
Blockly.Msg.STENDHAL_INOUT_MOSFET_INPUT = "que està connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_MOSFET_TOOLTIP = "El transistor MOSFET es un interruptor remot, és un interruptor posat en un circuit de potència que està accionat per una senyal digital";
Blockly.Msg.STENDHAL_INOUT_TEMP_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_TEMP_TEXT = "el valor analògic del captador de temperatura";
Blockly.Msg.STENDHAL_INOUT_TEMP_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_TEMP_TOOLTIP = "captador analògic, el bloc retorna un valor comprés entre 0 i 1023";
Blockly.Msg.STENDHAL_INOUT_LIGHT_HELPURL = "";
Blockly.Msg.STENDHAL_INOUT_LIGHT_TEXT = "el valor analògic del captador de llum";
Blockly.Msg.STENDHAL_INOUT_LIGHT_DIGITAL_TEXT = "l'estat del captador de llum";
Blockly.Msg.STENDHAL_INOUT_LIGHT_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_LIGHT_TOOLTIP = "captador analògic, el bloc retorna un valor comprés entre 0 i 1023";
Blockly.Msg.STENDHAL_INOUT_MOISTURE_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_MOISTURE_TEXT = "el valor analògic del captador de humitat del terra";
Blockly.Msg.STENDHAL_INOUT_MOISTURE_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_MOISTURE_TOOLTIP = "captador analògic, el bloc retorna un valor comprés entre 0 i 1023";
Blockly.Msg.STENDHAL_INOUT_SOUND_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_SOUND_TEXT = "el valor analògic del captador de so";
Blockly.Msg.STENDHAL_INOUT_SOUND_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_SOUND_TOOLTIP = "captador analògic, el bloc retorna un valor comprés entre 0 i 1023";
Blockly.Msg.STENDHAL_INOUT_DS18B20_TEXT1 = "captadors DS18B20";
Blockly.Msg.STENDHAL_INOUT_DS18B20_INPUT1 = "situats al pin";
Blockly.Msg.STENDHAL_INOUT_DS18B20_INPUT2 = "nombre";
Blockly.Msg.STENDHAL_INOUT_DS18B20_TOOLTIP1 = "inicialitza els captadors en sèrie al pin";
...
Blockly.Msg.STENDHAL_INOUT_DS18B20_TEXT2 = "atribueix a la variable";
Blockly.Msg.STENDHAL_INOUT_DS18B20_INPUT3 = "el valor del captador al pin";
Blockly.Msg.STENDHAL_INOUT_DS18B20_INPUT4 = "a la posició";
Blockly.Msg.STENDHAL_INOUT_DS18B20_TOOLTIP2 = "retorna el valor del captador de temperatura, en decimal flotant";
Blockly.Msg.STENDHAL_INOUT_PIR_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_PIR_TEXT = "l'estat del detector de moviment";
Blockly.Msg.STENDHAL_INOUT_PIR_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_PIR_TOOLTIP = "captador digital, el bloc retorna activat(1) o desactivat(0)";
Blockly.Msg.STENDHAL_INOUT_WATER_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_WATER_TEXT = "l'estat del detector d'aigua";
Blockly.Msg.STENDHAL_INOUT_WATER_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_INOUT_WATER_TOOLTIP = "captador digital, el bloc retorna activat(1) o desactivat(0)";
Blockly.Msg.STENDHAL_INOUT_LINE_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_LINE_TEXT = "l'estat del seguidor de línia";
Blockly.Msg.STENDHAL_INOUT_LINE_INPUT = "al pin";
Blockly.Msg.STENDHAL_INOUT_LINE_TOOLTIP = "retorna un estat digital en funció del color, blanc o negre, detectat";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_TEXT = "la distancia mesurada en cm";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_TEXT1 = "pel captador d'ultrasons";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_INPUT1= "connectat TRIGER al pin N°";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_INPUT2= "connectat ECHO al pin N°";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_INPUT3 = "velocidad del sonido en el medio (en m/s)";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_UNIT = "unitat";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_UNIT_CHOICE = [["cm", "cm"],  ["inch", "inch"]];
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_TOOLTIP = "mesurats per ecolocalització";
Blockly.Msg.STENDHAL_INOUT_MOTOR_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_MOTOR_TEXT = "motor a l'escut";
Blockly.Msg.STENDHAL_INOUT_MOTOR_CHOICE = [["aturat !", "stop"], ["avant", "forward"], ["a dreta", "right"], ["a esquerra", "left"], ["enrere", "backward"]];
Blockly.Msg.STENDHAL_INOUT_MOTOR_TOOLTIP = "pilot 2 motors de corrent continu";
Blockly.Msg.STENDHAL_INOUT_RGBLED_HELPURL = "";
Blockly.Msg.STENDHAL_INOUT_RGBLED_TEXT1 = "Connexions del LED RGB :";
Blockly.Msg.STENDHAL_INOUT_RGBLED_PIN1 = "- born roig al pin N°";
Blockly.Msg.STENDHAL_INOUT_RGBLED_PIN2 = "- born vert al pin N°";
Blockly.Msg.STENDHAL_INOUT_RGBLED_PIN3 = "- born blau al pin N°";
Blockly.Msg.STENDHAL_INOUT_RGBLED_TEXT2 = "Il·lumina el LED RGB amb els nivells :";
Blockly.Msg.STENDHAL_INOUT_RGBLED_COLOR1 = "- per la llum roja";
Blockly.Msg.STENDHAL_INOUT_RGBLED_COLOR2 = "- per la llum verda";
Blockly.Msg.STENDHAL_INOUT_RGBLED_COLOR3 = "- per la llum blava";
Blockly.Msg.STENDHAL_INOUT_RGBLED_TOOLTIP = "Connecta sobre 3 sortides analògiques (recorda ~). El nivell cal que estigui comprés entre 0 i 255";
Blockly.Msg.STENDHAL_LED_RGB_INPUT1 = "Per al LED RGB";
Blockly.Msg.STENDHAL_LED_RGB_INPUT2 = "el LED Roig està connectat al pin N°";
Blockly.Msg.STENDHAL_LED_RGB_INPUT3 = "el LED Vert està connectat al pin N°";
Blockly.Msg.STENDHAL_LED_RGB_INPUT4 = "el LED Blau està connectat al pin N°";
Blockly.Msg.STENDHAL_LED_PWM_HELPURL = "";
Blockly.Msg.STENDHAL_LED_PWM_INPUT1 = "I·lumina el LED que està connectat al pin N°";
Blockly.Msg.STENDHAL_LED_PWM_INPUT2 = "amb un nivell igual a";
Blockly.Msg.STENDHAL_LED_PWM_TOOLTIP = "Posa la sortida analògica a un nivell comprés entre entre 0 i 255";
Blockly.Msg.STENDHAL_INOUT_BT_HELPURL = "http://www.seeedstudio.com/wiki/Grove_-_Serial_Bluetooth";
Blockly.Msg.STENDHAL_INOUT_BT_COMM1 = "enllaç Bluetooth";
Blockly.Msg.STENDHAL_INOUT_BT_COMM2 = "al pin";
Blockly.Msg.STENDHAL_INOUT_BT_COMM3 = "nom del perifèric";
Blockly.Msg.STENDHAL_INOUT_BT_COMM4 = "codi secret";
Blockly.Msg.STENDHAL_INOUT_BT_COMM5 = "envia";
Blockly.Msg.STENDHAL_INOUT_BT_COMM6 = "rep";
Blockly.Msg.STENDHAL_INOUT_BT_TOOLTIP = "Bluetooth V2.0 + EDR esclau. Suportat sols un esclau per targeta";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR1 = "Targeta per a 4 motors de corrent continua";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_DIRECTION = "";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_VITESSE = "amb la velocitat de (de 0 a 255)";
Blockly.Msg.STENDHAL_MOTORSHIELD_AVANT = "avant";
Blockly.Msg.STENDHAL_MOTORSHIELD_ARRIERE = "enrere";
Blockly.Msg.STENDHAL_MOTORSHIELD_STOP = "atura";
Blockly.Msg.STENDHAL_MOTORSHIELD_PAP1 = "Targeta per motor pas a pas";
Blockly.Msg.STENDHAL_MOTORSHIELD_CONNECT = "Connecta un motor a la targeta";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_PPT = "pasos per volta";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_RPM = "velocitat (RPM)";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_NB_PAS = "nombre de passos";
Blockly.Msg.STENDHAL_EMETTEUR_IR_TEXT = "Led Infraroig IR";
Blockly.Msg.STENDHAL_EMETTEUR_IR_INPUT1 = "emet un senyal infraroig al pin";
Blockly.Msg.STENDHAL_EMETTEUR_IR_INPUT2 = "d'una freqüència (Hz) 38000 ";
...
Blockly.Msg.STENDHAL_EMETTEUR_IR_TOOLTIP = "Emissió d'un senyal infraroig";
...
Blockly.Msg.STENDHAL_BARRIERE_IR_TEXT = "l'estat del captador de llum infraroig";
Blockly.Msg.STENDHAL_BARRIERE_IR_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_BARRIERE_IR_TOOLTIP = "captador digital, el bloc retorna activat(1) o desactivat(0)";
...
Blockly.Msg.STENDHAL_OBSTACLE_IR_TEXT = "l'estat del detector d'obstacles amb llum infraroja";
Blockly.Msg.STENDHAL_OBSTACLE_IR_INPUT = "connectat al pin N°";
Blockly.Msg.STENDHAL_OBSTACLE_IR_TOOLTIP = "captador digital, el bloc retorna activat(1) o desactivat(0)";
Blockly.Msg.STENDHAL_INOUT_BT_AT_HELPURL = "";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM1 = "enllaç Bluetooth";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM2 = "al pin";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM3 = "nom del perifèric";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM4 = "codi secret";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM5 = "rep";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM6 = "envia";
Blockly.Msg.STENDHAL_INOUT_BT_AT_TOOLTIP = "Bluetooth V3.0 + EDR esclau. Suporta un sol esclau per targeta";
Blockly.Msg.STENDHAL_STEPPER_TITLE = "Defineix un motor pas a pas";
Blockly.Msg.STENDHAL_STEPPER_MOTOR = "amb el nom :";
...
Blockly.Msg.STENDHAL_STEPPER_SPEED = "Velocitat en voltes/min :";
Blockly.Msg.STENDHAL_STEPPER_STEPS = "Nombre de passos per volta :";
Blockly.Msg.STENDHAL_STEPPER_STEP1 = "Feu avançar el";
Blockly.Msg.STENDHAL_STEPPER_STEP2 = "de";
Blockly.Msg.STENDHAL_STEPPER_STEP3 = "passos en el sentir horari.";
Blockly.Msg.STENDHAL_STEPPER_TOOLTIP = "Configuració per defecte del model  24BYJ48. La velocitat es regula de 1 a 9 voltes/min. Els nombre de passos és per volta és 3072";
...
Blockly.Msg.grove_TF_Mini_LiDAR_ATTACH1 = "adjunta làser LiDAR";
Blockly.Msg.grove_TF_Mini_LiDAR_ATTACH2 = "amb nom";
Blockly.Msg.grove_TF_Mini_LiDAR_INPUT1 = "al pin (fil groc)";
Blockly.Msg.grove_TF_Mini_LiDAR_INPUT2 = "al pin (fil blanc)";
Blockly.Msg.grove_TF_Mini_LiDAR_attach_TOOLTIP = "defineix el pin connectat al LiDAR i usa el nom de la instància";
Blockly.Msg.grove_TF_Mini_LiDAR_distance_TITLE = "valor de la distancia";
Blockly.Msg.grove_TF_Mini_LiDAR_distance_TOOLTIP = "recupera el valor de la distancia, cal que estigui entre 30cm i 2 m";
Blockly.Msg.grove_TF_Mini_LiDAR_strength_TITLE = "intensitat del senyal";
Blockly.Msg.grove_TF_Mini_LiDAR_strength_TOOLTIP = "recupera la intensitat del senyal per quantificar la qualitat";
Blockly.Msg.grove_TF_Mini_LiDAR_chip_temp_TITLE = "temperatura interna del sensor";
Blockly.Msg.grove_TF_Mini_LiDAR_chip_temp_TOOLTIP = "recupera la senyal de la temperatura interna del sensor del microcontrolador";
...
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_SCAN_TOOLTIP = "llista totes les adreces dels components I2C al monitor sèrie, per defecte a 115200 bauds";
...
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_ATTACH1 = "adjunta l'escut I2C";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_ATTACH2 = "amb id";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_ATTACH3 = "al component";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_INPUT2 = " a l'adreça 0x";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_attach_TOOLTIP = "fixa l'adreça de la targeta d'extensió I2C i dona-li un identificador";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_INPUT1 = "estat lògic";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_INPUT2 = "pin";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_read_TOOLTIP = "els números de pin del 0 al 7 són 0.0 a 0.7, i del 8 al 15 són 1.0 a 1.7";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_OUTPUT1 = "configura l'estat inicial";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_OUTPUT2 = "del component";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_OUTPUT3 = "a";
Blockly.Msg.dfrobot_IIC_to_GPIO_Shield_V2_write_TOOLTIP = " els números de pin del 0 al 7 són 0.0 a 0.7, i del 8 al 15 són 1.0 a 1.7";

//********IIC to GPIO Module 21/02/2021
Blockly.Msg.I2C_to_GPIO_Module_SCAN_TEXT = "escaneja tots els dispositius I²C i informa pel monitor sèrie";
Blockly.Msg.I2C_to_GPIO_Module_SCAN_TOOLTIP = "llista totes les adreces dels components I2C al monitor sèrie, per defecte a 115200 bauds";
...
Blockly.Msg.I2C_to_GPIO_Module_ATTACH1 = "adjunta l'escut I2C";
Blockly.Msg.I2C_to_GPIO_Module_ATTACH2 = "amb id";
Blockly.Msg.I2C_to_GPIO_Module_ATTACH3 = "al component";
Blockly.Msg.I2C_to_GPIO_Module_INPUT1 = "a l'adreça 0x";
Blockly.Msg.I2C_to_GPIO_Module_attach_TOOLTIP = "configura l'escut d'extensió I2C i les seves adreces i configura un nom d'instància";
Blockly.Msg.I2C_to_GPIO_Module_INPUT2 = "estat lògic";
Blockly.Msg.I2C_to_GPIO_Module_INPUT3 = "del pin";
Blockly.Msg.I2C_to_GPIO_Module_read_TOOLTIP = "els números de pin del 0 al 7 són 0.0 a 0.7, i del 8 al 15 són 1.0 a 1.7";
Blockly.Msg.I2C_to_GPIO_Module_OUTPUT1 = "configura el pin";
Blockly.Msg.I2C_to_GPIO_Module_OUTPUT2 = "del component";
Blockly.Msg.I2C_to_GPIO_Module_OUTPUT3 = "a";
Blockly.Msg.I2C_to_GPIO_Module_write_TOOLTIP = "els números de pin del 0 al 7 són 0.0 a 0.7, i del 8 al 15 són 1.0 a 1.7";
