...
// definition of the target mockups
Blockly.Msg.CAT_MAKEBLOCK_TARGET_MBOT = "Robot mBot"; 
...
var MakeBlockPort1 = "Port1";
var MakeBlockPort2 = "Port2";
var MakeBlockPort3 = "Port3";
var MakeBlockPort4 = "Port4";
var MakeBlockPort5 = "Port5";
var MakeBlockPort6 = "Port6";
var MakeBlockPort7 = "Port7";
var MakeBlockPort8 = "Port8";

// redefine pin names for specific toolbox
if (toolboxId.indexOf('CAT_MAKEBLOCK_TARGET_MBOT') > -1) { // Load CAT_MAKEBLOCK_TARGET_MBOT
	alert("Load: CAT_MAKEBLOCK_TARGET_MBOT - " + toolboxId);
	MakeBlockPort2 = "Suiveur de ligne";
	MakeBlockPort3 = "Télémètre ultrason";
	
	Blockly.Msg.Makeblock_Mcore = [[MakeBlockPort1, '["12", "11"]'], [MakeBlockPort2, '["10", "9"]'], [MakeBlockPort3, '["A3", "A2"]'], [MakeBlockPort4, '["A1", "A0"]']];
//	Blockly.Msg.Makeblock_Orion = [[MakeBlockPort1, '["10", "11"]'], [MakeBlockPort2, '["9", "3"]'], [MakeBlockPort3, '["13", "12"]'], [MakeBlockPort4, '["2", "8"]'], [MakeBlockPort5, '["0", "1"]'], [MakeBlockPort6, '["A3", "A2"]'], [MakeBlockPort7, '["A1", "A6"]'], [MakeBlockPort8, '["A0", "A7"]']];
